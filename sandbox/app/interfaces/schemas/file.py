...
class FileReadRequest(BaseModel):
    ...
    start_line: Optional[int] = Field(default=None, ge=0, description="(可选)读取的起始行, 索引从0开始")
    end_line: Optional[int] = Field(default=None, ge=0, description="(可选)结束行号, 不包含该行")
    sudo: Optional[bool] = Field(default=False, description="(可选)是否使用sudo权限")
    max_length: Optional[int] = Field(default=10000, ge=1, le=1024 * 1024, description="(可选)要返回的内容的最大长度")
